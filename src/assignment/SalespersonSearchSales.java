...
public class SalespersonSearchSales extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SalespersonSearchSales frame = new SalespersonSearchSales(args);
	 ...
	 * Create the frame.
	 */
	public SalespersonSearchSales(String[] searchedSales) {
		...
		btnDeleteOrder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				obj1.deleteSales(ID);
                JOptionPane.showMessageDialog(SalespersonSearchSales.this, "Sales been deleted!");
                dispose();

			}
		});
		btnDeleteOrder.setBounds(365, 447, 116, 21);
